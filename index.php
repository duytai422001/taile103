...
<body>
    ...
    <nav>
        <ul>
        <li class="Iphone">
        <a href="Iphone.html"target="blank">Sieu Nhan</a> 
        </li>
       <li class="Applewatch">
        <a href="Applewatch.html"target="blank">Bup be</a> 
       </li> 
      <li class="MacBook"><a href="MacBook.html"target="blank">Gau bong</a> 
        </li>
        </ul>
    </nav>		
